    ...
    >
      <div className="max-w-[1080px] mx-auto px-3 sm:px-4 min-h-[3rem] sm:min-h-[3.5rem] flex flex-wrap items-center justify-between gap-2 sm:gap-4 py-2 sm:py-0">
        <div className="flex justify-start items-center gap-2 min-h-[44px] min-w-0">
          <Link href="/" className="flex items-center gap-1.5 sm:gap-2 text-yellow-500 hover:text-yellow-600 min-h-[44px] items-center py-1">
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3 min-h-[44px]">
          <div className="flex items-center gap-0.5 rounded border border-border p-0.5">
            <button
              ...
              className={`flex min-h-[36px] min-w-[36px] items-center justify-center rounded p-1.5 transition-colors ${
                theme === "light" ? "bg-zinc-200/80 dark:bg-zinc-700/50 text-zinc-800 dark:text-zinc-200" : "text-foreground/50 hover:text-foreground/70"
              }`}
            >
          ...
          {status === "loading" ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded p-1.5 text-error hover:bg-error/10"
                aria-label="Sign out"
              >
